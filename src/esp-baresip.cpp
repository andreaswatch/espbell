...
#define CONFIG_BARESIPTHREAD_STACKSIZE (16384)
...
#ifndef UA_USER
#define UA_USER "Esp32Doorbell"
#define UA_PASSWORD "Esp32Doorbell2020"
#endif
...
int sipPhoneInit(TypeGetNetworkAddress cbGetNetworkAddress)
{
	...
	mbuf_printf(mb, "\"" UA_DISPLAY_NAME "\" "
			"<sip:%s@%s>;auth_pass=%s;regint=0;answermode=auto", UA_USER, UA_PASSWORD, local_ip);
	mbuf_write_u8(mb, 0);
	mbuf_set_pos(mb, 0);
